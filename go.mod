...
require (
	...
	knative.dev/eventing-kafka v0.40.0 // indirect
)
...
require (
	...
	knative.dev/kn-plugin-source-kafka v0.40.0
...
replace knative.dev/kn-plugin-event => github.com/openshift-knative/kn-plugin-event v0.40.1-0.20240507105049-b1ae3219b6d0

...
require (
	...
	knative.dev/kn-plugin-event v1.4.0
	knative.dev/kn-plugin-func v1.7.0
...
require (
	...
	github.com/buildpacks/pack v0.24.0 // indirect
	...
	github.com/tektoncd/cli v0.23.1 // indirect
...
replace (
	// Pin version to prevent func pulling newer ones

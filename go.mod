...
require github.com/kiegroup/kie-tools/packages/kn-plugin-workflow v0.30.1
...
require (
	...
	github.com/kiegroup/kogito-serverless-operator/workflowproj v1.40.0 // indirect
...
replace (
	...
	knative.dev/hack => knative.dev/hack v0.0.0-20230113013652-c7cfcb062de9
	knative.dev/pkg => knative.dev/pkg v0.0.0-20230117181655-247510c00e9d

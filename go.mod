...
require (
	...
	github.com/openshift/source-to-image v1.3.10-0.20240223163641-625a537d6c7c // indirect
	...
	knative.dev/eventing-kafka-broker v0.41.0 // indirect
...
require (
	...
	knative.dev/func v1.14.0
	knative.dev/kn-plugin-event v1.12.0
...
replace (
	knative.dev/eventing => knative.dev/eventing v0.40.0
	knative.dev/hack => knative.dev/hack v0.0.0-20240123162936-f3f03ac0ab1a
	knative.dev/kn-plugin-event => github.com/openshift-knative/kn-plugin-event v0.41.1-0.20240507115421-2d940a652d48
...
replace knative.dev/func => github.com/openshift-knative/kn-plugin-func v1.1.3-0.20240606185726-aa90e5ef19e4

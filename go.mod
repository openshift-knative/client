...
require (
	...
	knative.dev/func v1.10.0
	knative.dev/hack v0.0.0-20230417170854-f591fea109b3
	knative.dev/kn-plugin-event v1.8.1
	knative.dev/kn-plugin-source-kafka v0.35.1
...
require (
	...
	github.com/buildpacks/pack v0.29.0 // indirect
...
require (
	...
	knative.dev/eventing-kafka v0.35.1 // indirect

)

replace knative.dev/kn-plugin-event => github.com/openshift-knative/kn-plugin-event v0.33.1-0.20230427120021-56309859a41a
...
replace (
	...
	knative.dev/func => github.com/openshift-knative/kn-plugin-func v1.1.3-0.20230428073150-5f9bc7bcb6cc
	...
	knative.dev/serving => knative.dev/serving v0.35.0
)

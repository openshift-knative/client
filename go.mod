...
require (
	...
	github.com/openshift/source-to-image v1.4.1-0.20240605122348-f94ff357628b // indirect
	...
	github.com/tektoncd/cli v0.37.0 // indirect
	github.com/tektoncd/pipeline v0.60.1 // indirect
...
require (
	...
	knative.dev/func v1.15.2
	knative.dev/kn-plugin-event v1.15.0
	knative.dev/kn-plugin-source-kafka v0.42.0
...
replace (
	...
	knative.dev/func => github.com/openshift-knative/kn-plugin-func v1.1.3-0.20241112130121-4a0863f717e3

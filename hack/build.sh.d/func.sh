...
readonly default_node_builder_image="${DEFAULT_NODE_BUILDER_IMAGE:-registry.access.redhat.com/ubi9/nodejs-20-minimal}"
readonly default_quarkus_builder_image="${DEFAULT_QUARKUS_BUILDER_IMAGE:-registry.access.redhat.com/ubi9/openjdk-21}"
readonly default_python_builder_image="${DEFAULT_PYTHON_BUILDER_IMAGE:-registry.access.redhat.com/ubi9/python-39}"
...
-X knative.dev/func/pkg/pipelines/tekton.DeployerImage=${func_util_image} \

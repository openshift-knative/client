...
-X knative.dev/func/pkg/builders/s2i/s2i.DefaultNodeBuilder=${default_node_builder_image} \
-X knative.dev/func/pkg/builders/s2i/s2i.DefaultQuarkusBuilder=${default_quarkus_builder_image} \
-X knative.dev/func/pkg/builders/s2i/s2i.DefaultPythonBuilder=${default_python_builder_image}"